...
def compile_excel_files(folder_path, output_file):
    ...
    dfs = []
    print("blank df for excel created")
    eval_timestamp()
    ...
    for excel_file in excel_files:
        ...
        print("excel df created")
        eval_timestamp()

    # output dfs to csv
    excel_data = pd.concat(dfs, ignore_index=True)
    excel_data = excel_data.to_csv(excel_to_csv, index=False)
    print(f"excel data saved to {excel_to_csv}")
    eval_timestamp()
    
    #get list of all csv files
    csv_files = [file for file in os.listdir(folder_path) if file.endswith('.csv')]
    print("csv file list retrieved")
    eval_timestamp()

    dfs = []
    print("blank df for csvs created")
    eval_timestamp()
...
def move_files_to_archive(folder_path, archive_path):
    ...
    print("used coupa file list retrieved")
    print(used_files)
    eval_timestamp()
...
output_file = 'C:/Users/MatthewHieger/Documents/My Tableau Repository/Datasources/Coupa Datamart/DATAMART COMPILE TEST/Invoice DM TEST Source.csv'
excel_to_csv = 'C:/Users/MatthewHieger/Documents/My Tableau Repository/Datasources/Coupa Datamart/DATAMART COMPILE TEST/Invoice DM for Today.csv'
