...
def process_begun():
    ...
    print("Supplier DM Source compilation began on", str_date_time)
...
def process_ended():
    ...
    timestamp = datetime.now()
    str_date_time = timestamp.strftime("%Y-%m-%d @ %H:%M:%S")
    print("Supplier DM Source compilation completed on", str_date_time)
    print(" ")
...
# Example usage
folder_path = 'C:/Users/MatthewHieger/Documents/My Tableau Repository/Datasources/Coupa Datamart/Supplier Datamart files'
output_file = 'C:/Users/MatthewHieger/Documents/My Tableau Repository/Datasources/Coupa Datamart/Supplier DM Source.csv'
