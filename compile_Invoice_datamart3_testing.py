...
def compile_excel_files(folder_path, output_file):
    ...
    date_columns = clean_data.loc[:,('Created Date', 'Last Updated Date', 'Payment Date', 'Date Received')]
...
output_file = 'C:/Users/MatthewHieger/Documents/My Tableau Repository/Datasources/Coupa Datamart/Invoice DM3 Source.csv'
